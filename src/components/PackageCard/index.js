...
export default function PackageCard({ data }) {
  return (
    <Link href={`/packages/${data?.slug}`}  className="group block relative overflow-hidden rounded-3xl bg-[linear-gradient(346deg,rgb(58_122_227/89%)_10%,#aac1e4_0%,#0e52a4_104%)] hover:scale-95 will-change-transform scale-100 ease-in-out duration-500  text-white">
