...
export default function ExploreLink({children,href, variant},props) {
  return (
    <Link href={href?href:"/"} {...props} className="group relative inline-flex items-center justify-start bg-gradient-to-r from-[#3C7FE6] to-[#639CF4] rounded-[100px] py-[10px] pr-[10px] pl-5 transition-all duration-300 ease-in-out active:rounded-[12px]">
        {/* Label */}
