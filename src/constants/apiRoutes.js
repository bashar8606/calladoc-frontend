...
export const LEADER_PAGE = "/api/doctor-page?populate=widgets.cover,widgets.items.img,seo,seo.shareImage,seo.ogImage"
export const SERVICE_PAGE = "/api/service-page?populate=widgets.items.img,widgets.items.cover,widgets.link,widgets.cover,widgets.items.category,seo,seo.shareImage,seo.ogImage"
export const LEADER_SINGLE = "/api/doctors"
export const PACKAGES_PAGE = "/api/packages"   
export const ISSUE_SINGLE = "/api/issues"
export const ISSUES_PAGE = "/api/issues-page?populate=widgets.cover,widgets.items.cover,seo,seo.shareImage,seo.ogImage"
export const MEDIA_PAGE = "/api/media?populate=widgets.cover,widgets.items.cover,widgets.popular.cover,widgets.latest.cover,seo,seo.shareImage,seo.ogImage"
export const MEDIA_SINGLE = "/api/articles"
export const PACKAGE_PAGE = "/api/package-page?populate=widgets.items.img,widgets.cover,widgets.items.cover,widgets.items.category,widgets.link.label,seo,seo.shareImage,seo.ogImage"
export const SERVICE_CATEGORIES = "/api/service-categories"