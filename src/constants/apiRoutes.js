...
//pages
export const GLOBAL = "/api/global?populate[favicon]=true&populate[menu][populate][sub][populate][links]=true&populate[footer][populate][link]=true";
...
export const SERVICE_PAGE = "/api/service-page?populate=widgets.items.img,widgets.items.cover,widgets.link,widgets.cover,widgets.items.category,seo"
...
export const PACKAGE_PAGE = "/api/package-page?populate=widgets.items.img,widgets.cover,widgets.items.cover,widgets.items.category,widgets.link.label,seo"
