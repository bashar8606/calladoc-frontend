    ...
    <section className={`overflow-hidden bg-slate-50 py-12 2xl:py-[100px]`} id="LeaderDetail">
      <div className="container">
        <div className="2xl:px-24">
          {/* <div className="grid grid-cols-12 lg:gap-x-5 gap-y-4 justify-center items-center"> */}
            <div className="max-w-[800px] mx-auto">
            <p className="mt-5 text-black/50 font-medium text-base  leading-relaxed lg:leading-relaxed mb-3">Qualifications
</p>
