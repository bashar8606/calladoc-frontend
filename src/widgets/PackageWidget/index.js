  ...
  return (
    ...
    >
      ...
      <div className="container">
        ...
        <Card className="w-full h-full mx-auto overflow-hidden  max-w-md relative bg-white/30 border border-[#d4e1ff] shadow-[1px_3px_11px_0px_#dbe6ff] backdrop-blur-[12px] rounded-[36px] p-[30px]">
          <span
          ...
          <div className="md:flex  mb-6  justify-center ">
          ...
          {data?.items?.map((item, i) => {
            return (
              <div
                key={i}
                className={`p-3  ${i !== data?.items.length - 1 ? "border-r border-[#d4e1ff]" : ""}`}
              >
                 <div className="mb-1">
            <h3 className="text-sm uppercase tracking-wider font-bold text-[#2463eb] mb-1 text-center">
              {item?.type}
            </h3>
            {item?.description && (
